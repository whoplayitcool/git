package com.tianhe.live.tianhecheck.calendar;
...
public class CalendarCard extends View {
	...
	private void init(Context context) {
		...
		mCirclePaint.setColor(Color.parseColor("#0000FF")); // 红色圆形
	 ...
	 */
	enum State {
		TODAY,CURRENT_MONTH_DAY, PAST_MONTH_DAY, NEXT_MONTH_DAY, UNREACH_DAY,LATE_DAY;
	}
